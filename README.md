...
### Reuslts
![visualisation of top skills required for Data jobs](Project/Images/skill_demand_all_data_roles.png)
...
```python 
df_plot = df_DA_US_percent.iloc[:, :3]
...
### Results
![skills trend over the months of 2023](Project/Images/skills_tren_over_month.png)
...
![Visualisation for median salary anaysis](Project/Images/median_salary_analysis.png)
...
![Visualisation of pay vs skill](Project/Images/pay_vs_skill.png)
...
![Visualisation of salary distribution](Project/Images/salary_distribution.png)
...
![Visualisation of Optimal Skills](Project/Images/Optimal_Skills.png)
